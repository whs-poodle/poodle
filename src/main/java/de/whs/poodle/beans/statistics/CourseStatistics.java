...
/*
 * Global Statistics for a course used in CourseStatisticsController.
 *
 * The CourseStatistic contains a map which maps each CourseTerm of the course
 * to a corresponding TotalCourseTermStatistics object.
 */
